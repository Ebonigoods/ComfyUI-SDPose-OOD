...
3. **Check System Requirements**: Ensure your computer meets the minimum requirements to run ComfyUI-SDPose-OOD:
...
4. **Install the Application**:
   ...
   - For macOS:
      ...
      - Open the file and drag the ComfyUI-SDPose-OOD icon into your Applications folder.

5. **Run ComfyUI-SDPose-OOD**: After installation, locate the application in your Start Menu (Windows) or Applications folder (macOS) and double-click to run it.

## 📂 Features
ComfyUI-SDPose-OOD comes loaded with several features designed for ease of use:
- **Integration with SDPose-OOD**: Quickly apply SDPose features in your projects.
- **User-Friendly Interface**: A simple layout makes navigation easy for all users.
- **Customizable Settings**: Adapt the software to fit your specific needs.
